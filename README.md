...
Модели отражения:
0 - Модель Ламберта (диффузное отражение)
1 - Модель Фонга-Блинна (диффузное + зеркальное)
2 - Модель Торренса-Сперроу (продвинутая модель для шероховатых поверхностей)
...
Компиляция:
# Из командной строки разработчика (x64)
